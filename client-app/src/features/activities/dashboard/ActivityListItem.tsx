...
import ActivityListItemsAttendees from './ActivityListItemsAttendees'
...
const ActivityListItem: React.FC<{activity: IActivity}> = ({activity}) => {
    ...
    return (
        <Segment.Group>
                    ...
                    <Item>
                        ...
                        <Item.Content>
                            ...
                            <Item.Description>Hosted by 
                                <Link to ={`profile/${host.username}`}>{host.displayName}</Link> </Item.Description>
                            {activity.isHost && 
                            <Item.Description>
            ...
            <Segment secondary>
                <ActivityListItemsAttendees attendees = {activity.attendees}/>
            </Segment>
            <Segment clearing>
